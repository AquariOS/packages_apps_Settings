...
LOCAL_SRC_FILES += $(call all-java-files-under, ../SmartActionSettings/src)
...
LOCAL_RESOURCE_DIR := $(LOCAL_PATH)/res \
    ...
    packages/apps/SmartActionSettings/res
...
LOCAL_FULL_LIBS_MANIFEST_FILES += packages/apps/SmartActionSettings/AndroidManifest.xml
